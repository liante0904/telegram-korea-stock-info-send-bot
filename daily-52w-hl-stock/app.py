...
naver_api_high_52k_kospi  = os.getenv('naver_api_high_52k_kospi')
naver_api_high_52k_kosdaq = os.getenv('naver_api_high_52k_kosdaq')
naver_api_low_52k_kospi   = os.getenv('naver_api_low_52k_kospi')
naver_api_low_52k_kosdaq  = os.getenv('naver_api_low_52k_kosdaq')
...
async def NAVER_52weekPrice_check():
    ...
    TARGETS = [
        (naver_api_high_52k_kospi  , '코스피 52주 신고가'),
        (naver_api_high_52k_kosdaq , '코스닥 52주 신고가'),
        (naver_api_low_52k_kospi   , '코스피 52주 신저가'),
        (naver_api_low_52k_kosdaq  , '코스닥 52주 신저가')
    ]
